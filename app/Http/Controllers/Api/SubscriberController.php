...
class SubscriberController extends Controller
{
    ...
    public function index(Request $request, $list_id)
    {
        ...
        $items = \Acelle\Model\Subscriber::search($request, $request->selected_customer)
    ...
    public function store(Request $request, $list_id)
    {
        try {
            ...
            if ($request->isMethod('post')) {
                ...
                // Log
                $subscriber->log('created', $request->selected_customer);
    ...
    public function subscribe($list_id, $id)
    {
        ...
        // Log
        $subscriber->log('subscribed', $request->selected_customer);
    ...
    public function unsubscribe($list_id, $id)
    {
        ...
        // Log
        $subscriber->log('unsubscribed', $request->selected_customer);
    ...
    public function delete($list_id, $id)
    {
        ...
        // Log
        $subscriber->log('deleted', $request->selected_customer);
