...
use Acelle\ShopifyModel\DiscountCode;
use Acelle\ShopifyModel\PriceRule;
 ...
 *
 * @property ShopifyPriceRule shopify_price_rule
 */
class ShopifyDiscountCode extends Model
{
    const COLUMN_id = 'id';
    ...
    const COLUMN_price_rule_id = 'price_rule_id';
    ...
    static function findByCustomer($customer_id)
    {
        return self::where(self::COLUMN_customer_id, $customer_id)->get();
    }
    ...
    static function storeDiscountCode(ShopifyShop $shop, array $data)
    {
        ...
        $model->discount_code = $model->getShopifyModel()->code;
        $price_rule_shopify_id = $model->getShopifyModel()->price_rule_id ?? "";
        $model->price_rule_id = ShopifyPriceRule::findByShopifyId($price_rule_shopify_id)->id;
    ...
    function shopify_price_rule(): BelongsTo
    {
        return $this->belongsTo(ShopifyPriceRule::class, self::COLUMN_price_rule_id);
    }
