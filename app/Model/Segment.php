...
/**
 * @property int id
 * @property SegmentCondition[] segmentConditions
...
class Segment extends Model
{
            ...
            if (isset($condition->field_id)) {
                ...
                switch ($condition->operator) {
                    ...
                    case 'last_link_click_greater_than_days':
                        ...
                        break;
                    default:
                        //todo: research and handle this issue
                        //throw new \Exception("Unknown segment condition type (operator): " . $condition->operator);
                }
            }
        }
    ...
    {
        $query = Subscriber::select('subscribers.*', 'email_verifications.result AS verify_result');
