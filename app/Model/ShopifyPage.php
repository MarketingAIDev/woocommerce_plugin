 ...
 * @property string shopify_author
...
class ShopifyPage extends Model
{
    ...
    const COLUMN_shopify_author = 'shopify_author';
    ...
    static function storePage(ShopifyShop $shop, array $data)
    {
        ...
        $model->shopify_author = $model->getShopifyModel()->author;
    ...
    public static function scopeSearch($query, $search)
    {
        $query->where(function ($q) use ($search) {
            $q->where(self::COLUMN_shopify_title, 'like', "%$search%")
                ->orWhere(self::COLUMN_shopify_author, 'like', "%$search%");
        });
        return $query;
    }
}
