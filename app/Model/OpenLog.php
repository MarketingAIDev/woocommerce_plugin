...
class OpenLog extends Model
{
    ...
    {
        return $this->belongsTo(IpLocation::class, 'ip_address', 'ip_address');
    }
    ...
    public static function search($request, $campaign = null)
    {
        ...
        if ($request->sort_direction && $request->sort_order && in_array($request->sort_order, self::SORTABLE_COLUMNS))
