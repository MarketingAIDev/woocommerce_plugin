...
class ShopifyPriceRule extends Model
{
    ...
    static function findByShop(ShopifyShop $shop)
    {
        return self::where(self::COLUMN_shop_id, $shop->id)->get();
    }
    ...
    static function storePriceRule(ShopifyShop $shop, array $data)
    {
