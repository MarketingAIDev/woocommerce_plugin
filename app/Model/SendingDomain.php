 ...
 * @property string verification_hostname
...
class SendingDomain extends Model
{
    ...
    public function getAllRecords(){
        $records = [
            [
                "host_name" => $this->getFullVerificationHostName(),
                "value" => $this->verification_token,
                "verified" => $this->domainVerified()],
            [
                "host_name" => $this->getFullDkimHostName(),
                "value" => $this->getDnsDkimConfigWithoutQuote(),
                "verified" => $this->dkimVerified()],
            [
                "host_name" => $this->getDnsHostName(),
                "value" => $this->getSpf(),
                "verified" => $this->spfVerified()
            ],
        ];
        return $records;
    }
