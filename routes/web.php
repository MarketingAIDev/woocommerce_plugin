...
use Acelle\Library\File as FileHelper;
...
// Installation
Route::post('/changeintrackingstatus', 'TrackingFulfillmentController@changeInTrackingStatus');
...
// assets path for test emails
Route::get('/assets/test_emails/{uid}/{name?}', [function ($uid, $name) {
    $path = storage_path('app/users/' . $uid . '/test_mail_assets/' . $name);
    if (File::exists($path)) {
        return response()->file($path, array('Content-Type' => FileHelper::getFileType($path)));
    }
    return response('', 404);
}])->where('name', '.+')->name('test_email_assets');
...
// Common resources useful for the React Application
Route::get('/common-resources/csrf-token', 'CommonResourcesController@getCSRFToken');
Route::get('/common-resources/countries', 'CommonResourcesController@getCountries');
Route::get('/common-resources/timezones', 'CommonResourcesController@getTimezones');

Route::group(['prefix' => '_shopify'], function () {
    Route::get('/widgets', 'GuestWidgetController@widgets_status');

    // Popups
    Route::get('popups', 'PopupGuestController@index');
    Route::get('popup', 'PopupGuestController@view');
    Route::post('popup/submit', 'PopupGuestController@submit');
    Route::post('popup/mark_shown', 'PopupGuestController@mark_shown');

    // Shopify Reviews
    Route::get('reviewStats', 'ShopifyReviewGuestController@reviewStats');
    Route::post('storeFromReviewer', 'ShopifyReviewGuestController@store');
    Route::post('storeFromReviewerSilently', 'ShopifyReviewGuestController@storeSilently');
    Route::post('updateReviewFetchStatus', 'ShopifyReviewGuestController@updateReviewFetchStatus');
    Route::get('embedShopifyReviews', 'ShopifyReviewGuestController@embed');
    Route::get('embedAllShopifyReviews', 'ShopifyReviewGuestController@embedAll');

    Route::get('review/{uid}/{secret_key}', 'ShopifyReviewGuestController@view');
    Route::post('review/{uid}/{secret_key}', 'ShopifyReviewGuestController@updateFromReviewer');

    // Shopify Chats
    Route::get('chat/sessions/get_or_create', 'ChatSessionController@getSessionAndSettings');
    Route::post('chat/sessions/update', 'ChatSessionController@updateSession');
    Route::post('chat/sessions/new', 'ChatSessionController@store');
    Route::post('chat/sessions/end', 'ChatSessionController@endSession');
    Route::post('chat/messages/listGuest', 'ChatMessageController@listGuest');
    Route::post('chat/messages/storeGuest', 'ChatMessageController@storeGuest');
    Route::post('chat/messages/read', 'ChatMessageController@listGuest');   // copy of listGuest
    Route::post('chat/messages/send', 'ChatMessageController@storeGuest');  // copy of storeGuest
    Route::get('chat/settings/readGuest', 'ChatSettingController@readGuest');
    Route::get('review/settings/readGuest', 'ReviewSettingController@readGuest');

    // Shopify webhooks
    Route::post('webhook', 'ShopifyWebhookController@process')->name('shopifyWebhookUrl');
});

Route::group(['prefix' => '_builder_demo'], function () {
    Route::get('discount_codes', 'EwDynamicDemoController@discount_codes');
    Route::get('select2_product', 'EwDynamicDemoController@select2_product');
    Route::get('images', 'EwDynamicDemoController@images');
    Route::get('query', 'EwDynamicDemoController@query');
    Route::get('blogs', 'EwDynamicDemoController@blogs');
    Route::get('pages', 'EwDynamicDemoController@pages');
    Route::post('send_email', 'EwDynamicDemoController@send_email');
});
...
Route::group(['middleware' => ['not_installed', 'not_logged_in']], function () {
    ...
    Route::post('users/aff', 'UserController@affiliate');
});
...
Route::group(['middleware' => ['not_installed']], function () {
    ...
    Route::get('plans/listing', 'PlanController@listing');

    // Shopify shops
    Route::get('shopify_shops/listing', 'ShopifyShopController@listing');
    Route::match(['get', 'delete'], 'shopify_shops/delete', 'ShopifyShopController@delete');
    Route::resource('shopify_shops', 'ShopifyShopController');
    ...
    Route::match(['get', 'post'], 'campaigns/{message_id}/unsubscribe', 'CampaignController@unsubscribe')->name('unsubscribeUrl');
    ...
    // Onboarding
    Route::post('/onboarding/register_form', 'OnBoardingController@register_form');
    Route::post('/onboarding/re_authorize', 'OnBoardingController@re_authorize');
    Route::post('/onboarding/step_one', 'OnBoardingController@step_one');
    Route::post('/onboarding/select_plan', 'OnBoardingController@select_plan');
    Route::post('/onboarding/change_plan', 'OnBoardingController@change_plan');
    Route::post('/onboarding/complete_plan', 'OnBoardingController@complete_plan');
    Route::post('/onboarding/abort', 'OnBoardingController@abort_onboarding');
});
...
Route::group(['middleware' => ['not_installed', 'auth', 'frontend', 'subscription']], function () {
    ...
    Route::get('/ip_location', 'HomeController@ip_location');
    Route::get('/home_dashboard', 'HomeController@home_dashboard');
    Route::get('/reports', 'HomeController@reports');
    Route::get('/popup_summary', 'HomeController@popup_summary');


    Route::get('/email_dashboard', 'HomeController@email_dashboard');
    Route::get('/sync_status', 'HomeController@sync_status');
    Route::get('/global_search', 'HomeController@global_search');
    Route::get('/shopify_subscription', 'HomeController@shopify_subscription');
    Route::get('/cb_snippets', 'HomeController@cb_snippets');
    Route::post('/automations_imported', 'HomeController@update_automation_import_timestamp');
    Route::post('/popups_imported', 'HomeController@update_popup_import_timestamp');
    Route::get('/frontend/docs/api/v1', 'Controller@docsApiV1');
    Route::get('/current_user_uid', 'UserController@showUid');
    Route::get('/current_user', 'UserController@fetchUser');
    Route::post('/fcm_token', 'UserController@fcm_token');

    Route::get('/modules_status', 'HomeController@modules_status');
    Route::match(['get', 'post'], '/popup_module_status', 'HomeController@popup_module_status');
    Route::match(['get', 'post'], '/review_module_status', 'HomeController@review_module_status');
    Route::match(['get', 'post'], '/chat_module_status', 'HomeController@chat_module_status');
    ...
    // Dynamic content for builder
    Route::group(['prefix' => 'ew_dynamic'], function () {
        Route::get('preview/{type}', 'EwDynamicController@preview');
        Route::get('setup/{type}', 'EwDynamicController@setup');
        Route::get('select2_product', 'EwDynamicController@select2_product');
        Route::get('discount_codes', 'EwDynamicController@discount_codes');
        Route::get('images', 'EwDynamicController@images');
        Route::get('query', 'EwDynamicController@query');
        Route::get('blogs', 'EwDynamicController@blogs');
        Route::get('pages', 'EwDynamicController@pages');
        Route::get('best_selling_products', 'EwDynamicController@best_selling_products');
        Route::post('send_email', 'EwDynamicController@send_email');
    });

    // Chats
    Route::get('/chat/sessions', 'ChatMessageController@sessions');
    Route::get('/chat/liveSessions', 'ChatMessageController@liveSessions');
    Route::get('/chat/sessions/{session_id}/attachments', 'ChatMessageController@attachments');
    Route::patch('/chat/sessions/{session_id}', 'ChatMessageController@updateSession');
    Route::post('/chat/messages/store', 'ChatMessageController@store');
    Route::post('/chat/messages/chatEnd', 'ChatMessageController@chatEnd');
    Route::get('/chat/messages/list', 'ChatMessageController@list');
    Route::get('/chat/summary', 'HomeController@chat_summary');
    Route::get('/chat/settings', 'ChatSettingController@index');
    Route::post('/chat/settings', 'ChatSettingController@store');
    Route::get('/review/settings', 'ReviewSettingController@index');
    Route::post('/review/settings', 'ReviewSettingController@store');
    ...
    Route::match(['get', 'delete'], 'lists/delete', 'MailListController@delete');
    ...
    Route::match(['get', 'delete'], 'lists/{list_uid}/fields/{uid}/delete', 'FieldController@delete');
    ...
    Route::match(['get', 'delete'], 'lists/{list_uid}/segments/delete', 'SegmentController@delete');
    ...
    Route::get('templates/builder/templateLayouts', 'TemplateController@templateLayouts');
    ...
    Route::get('templates/{uid}/tags', 'TemplateController@tags');
    ...
    Route::post('templates/{uid}/builder/content_builder_save', 'TemplateController@contentBuilderSave');
    ...
    Route::match(['get', 'delete'], 'templates/delete', 'TemplateController@delete');
    ...
    // Campaign
    Route::get('campaigns/{uid}/summary', 'CampaignController@summary');
    ...
    Route::get('campaigns/{uid}/get-attachments', 'CampaignController@getAttachments');
    ...
    Route::post('campaigns/{uid}/template/theme_upload', 'CampaignController@templateThemeUpload');
    ...
    Route::match(['get', 'delete'], 'campaigns/delete', 'CampaignController@delete');
    Route::get('campaigns/select2', 'CampaignController@select2');
    Route::match(['get', 'post'], 'campaigns/pause', 'CampaignController@pause');
    Route::match(['get', 'post'], 'campaigns/restart', 'CampaignController@restart');
    ...
    Route::get('campaigns/{uid}/tags', 'CampaignController@tags');
    ...
    Route::match(['get', 'delete'], 'sending_servers/delete', 'SendingServerController@delete');
    ...
    Route::match(['get', 'delete'], 'shopify_reviews/delete', 'ShopifyReviewController@delete');
    Route::post('shopify_reviews/approve', 'ShopifyReviewController@approve');
    Route::post('shopify_reviews/verify', 'ShopifyReviewController@verify');
    Route::get('shopify_reviews/products', 'ShopifyReviewController@getProducts');
    Route::post('shopify_reviews/refetch', 'ShopifyReviewController@refetchReviews');
    Route::get('shopify_reviews/listing/{page?}', 'ShopifyReviewController@listing');
    Route::get('shopify_reviews/embed/{page?}', 'ShopifyReviewController@embed');
    Route::get('shopify_reviews/', 'ShopifyReviewController@index');
    Route::post('shopify_reviews/', 'ShopifyReviewController@store');
    Route::get('shopify_reviews/{uid}', 'ShopifyReviewController@show');
    Route::patch('shopify_reviews/{uid}', 'ShopifyReviewController@update');

    Route::get('shopify_data/products', 'ShopifyDataController@products');
    Route::get('shopify_data/products_select', 'ShopifyDataController@products_select');

    Route::get('popups/public_popups', 'PopupController@public_popups');
    Route::post('popups/{uid}/copy', 'PopupController@copy');
    Route::post('popups/{uid}/update_public_flag', 'PopupController@update_public_flag');
    Route::get('popups/responses', 'PopupController@responses');
    Route::match(['get', 'delete'], 'popups/delete', 'PopupController@delete');
    Route::get('popups/search', 'PopupController@search');
    Route::get('popups/listing/{page?}', 'PopupController@listing');
    Route::resource('popups', 'PopupController');
    Route::patch('popups/{popup}/trigger', 'PopupController@update_trigger');
    Route::get('popups/{popup}/thumbnail', 'PopupController@thumbnail');

    Route::match(['get', 'delete'], 'gallery_images/delete', 'GalleryController@delete');
    Route::get('gallery_images/listing/{page?}', 'GalleryController@listing');
    Route::post('gallery_images', 'GalleryController@store');

    Route::get('signature', 'SignatureController@index');
    Route::post('signature', 'SignatureController@store');

    Route::get('social_media_links', 'SocialMediaLinkController@index');
    Route::match(['get', 'delete'], 'social_media_links/delete', 'SocialMediaLinkController@delete');
    Route::post('social_media_links', 'SocialMediaLinkController@store');
    Route::patch('social_media_links/{uid}', 'SocialMediaLinkController@update');
    ...
    Route::match(['get', 'delete'], 'sending_domains/delete', 'SendingDomainController@delete');
    ...
    Route::match(['get', 'delete'], 'tracking_domains/delete', 'TrackingDomainController@delete');
    ...
    Route::match(['get', 'delete'], 'email_verification_servers/delete', 'EmailVerificationServerController@delete');
    ...
    Route::match(['get', 'delete'], 'blacklists/delete', 'BlacklistController@delete');
    ...
    Route::match(['get', 'delete'], 'senders/delete', 'SenderController@delete');
    ...
    Route::get('default_automations/discount_coupons', 'DefaultAutomationsController@discount_coupons');
    Route::post('default_automations/create_automations', 'DefaultAutomationsController@create_automations');
    Route::post('default_automations/skip_automations', 'DefaultAutomationsController@skip_automations');
    ...
    Route::get('automation2/{uid}/tags', 'Automation2Controller@tags');
    ...
    Route::match(['get', 'delete'], 'automation2/delete', 'Automation2Controller@delete');
    Route::get('automation2/listing', 'Automation2Controller@listing');
    Route::get('automation2', 'Automation2Controller@index');

    Route::get('automation2/public_automations', 'Automation2Controller@public_automations');
    Route::post('automation2/{uid}/update_public_flag', 'Automation2Controller@update_public_flag');
    Route::post('automation2/{uid}/copy', 'Automation2Controller@copy');
    ...
    // Segmentation
    Route::get('/segment2/select_box', 'Segment2Controller@selectBox');
    Route::get('/segment2/listing', 'Segment2Controller@listing');
    Route::post('/segment2/delete', 'Segment2Controller@deleteMany');
    Route::get('/segment2/condition_type_options', 'Segment2Controller@condition_type_options');
    Route::get('/segment2/property_comparison_options/{propertyType}', 'Segment2Controller@property_comparison_options');
    Route::post('/segment2', 'Segment2Controller@store');
    Route::get('/segment2/{segment2}', 'Segment2Controller@view');
    Route::delete('/segment2/{segment2}', 'Segment2Controller@destroy');
    Route::patch('/segment2/{segment2}', 'Segment2Controller@update');

    Route::post('/segment2/{segment2}/groups', 'Segment2Controller@store_group');
    Route::delete('/segment2/{segment2}/groups/{group}', 'Segment2Controller@delete_group');
    Route::post('/segment2/{segment2}/groups/{group}/conditions', 'Segment2Controller@store_condition');
    Route::delete('/segment2/{segment2}/groups/{group}/conditions/{condition}', 'Segment2Controller@delete_condition');
    Route::get('/segment2/{segment2}/customers', 'Segment2Controller@customers');
...
Route::group(['namespace' => 'Admin', 'middleware' => ['not_installed', 'auth', 'backend']], function () {
    ...
    Route::get('admin/refresh_widgets', function () {
    ...
    Route::get('admin/templates/{uid}/builder/edit/tags', 'TemplateController@tags');
    ...
    Route::match(['patch', 'post'], 'admin/templates/{uid}/update', 'TemplateController@update');
