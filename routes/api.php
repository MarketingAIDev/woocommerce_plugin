...
Route::group(['namespace' => 'Api', 'prefix' => 'v1', 'middleware' => []], function () {
    //
    Route::get('', function(){
    ...
    // File
    Route::match(['post', 'get'],'automations/{uid}/execute', 'AutomationController@execute')->name('automation_execute');
});
