...
@section('content')
    ...
    <div id="dynamicCart" class="is-tab-content" data-group="button" style="display:block">
        <div style="width:100%;">
    ...
    <script>
        ...
        const input_cart_id = document.getElementById("input_cart_id")
