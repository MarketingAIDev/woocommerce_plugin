...
@section('content')
    ...
    <hr >
    <div class="text-left">
        <a callback="" data-method="POST" href="{{ action('SendingDomainController@verify', $server->uid) }}" class="btn btn-info bg-teal ajax_link">{{ trans('messages.sending_domain.verify') }}</a>
    </div>
