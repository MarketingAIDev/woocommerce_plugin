            ...
            <div class="row">
                <div class="col-md-7">
                    ...
                    <div class="stats-boxes">
                        ...
                        <div class="width1of4 stats-box">
                            <h3>
                                <a href="{{ action('Admin\PlanController@quota', $plan->uid) }}">{{ $plan->displayFreeQuota() }}</a>
                            </h3>
                            <p>{{ "Free credits" }}</p>
                        </div>
                        <div class="width1of4 stats-box">
                            <h3>
                                <a href="{{ action('Admin\PlanController@quota', $plan->uid) }}">
                                    $ {{ $plan->getMaximumUsageChargeAttribute() }}
                                </a>
                            </h3>
                            <p>Monthly usage charge limit</p>
                        </div>
                        <div class="width1of4 stats-box">
                            <h3>
                    ...
                    @include('helpers.form_control', [
                        'class' => 'numeric',
                        'type' => 'text',
                        'name' => 'plan[general][usage_rate]',
                        'label' => 'Usage rate beyond free credits',
                        'value' => $plan->usage_rate,
                        'help_class' => 'plan',
                        'rules' => $plan->generalRules()
                    ])
