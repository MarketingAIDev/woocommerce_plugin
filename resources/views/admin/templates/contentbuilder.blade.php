...
<script>
    ...
    let builder = new ContentBuilder({
        ...
        uploadAssetUrl: '<?= action([\Acelle\Http\Controllers\Admin\TemplateController::class, 'builderAsset'], ['uid'=>$template->uid])?>',
        ewTagsSource: '<?= action([\Acelle\Http\Controllers\Admin\TemplateController::class, 'tags'], ['uid' => $template->uid])?>',
    ...
    function saveScreenshot() {
        const screenshotSaveURL = '{{ action([\Acelle\Http\Controllers\Admin\TemplateController::class, 'saveImage'], ['uid' =>$template->uid]) }}';
    ...
    const process = () => {
        ...
        btnGetHtml.addEventListener('click', function () {
            ...
            const saveURL = '{{ action([\Acelle\Http\Controllers\Admin\TemplateController::class, 'update'], ['uid' => $template->uid]) }}';
            const csrf_token = "{{ csrf_token() }}";
