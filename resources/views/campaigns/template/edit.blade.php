    ...
    <script>
        ...
        $(document).ready(function () {
            editor = new Editor({
                ...
                templates: templates,
                logo: '{{ \Acelle\Model\Setting::get('site_logo_small') ? action('SettingController@file', \Acelle\Model\Setting::get('site_logo_small')) : URL::asset('images/logo_emailwish.png') }}',
                backgrounds: [
