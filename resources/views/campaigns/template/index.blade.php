        ...
        <div class="col-md-8 mb-40">
                ...
                <div class=" mr-auto pr-2">                    
                    ...
                    <div class="media-left">
                        <div class="main">
                            ...
                            <p class="mt-20">
                                <a href="{{ action('CampaignController@templateCreate', $campaign->uid) }}" class="btn btn-info bg-grey-600 mr-5">
                                    {{ trans('messages.campaign.change_template') }}
                                </a>
                                @if (in_array(Acelle\Model\Setting::get('builder'), ['both','pro']))
                                    <a href="{{ action('CampaignController@templateEdit', $campaign->uid) }}" class="btn btn-info mr-5 template-compose">
            ...
            @if ($spamscore)
                <div class="sub-section">
                    ...
                    <a href="#" id="calculate-score" class="btn btn-info bg-grey-600 mr-5">
