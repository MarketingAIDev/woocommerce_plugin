    ...
    <div class="row list-segment-container">
        ...
        >
            @include('helpers.form_control', [
                ...
                'options' => request()->selected_customer->getMailListSelectOptions([], true),
                'rules' => isset($rules) ? $rules : []
            ])
        </div>
        <div class="col-md-5 segments-select-box multiple">
            @if (is_object($lists_segment_group['list']) && collect($lists_segment_group['list']->getSegmentSelectOptions(true))->count())
                @include('helpers.form_control', [
                    ...
                    'options' => collect($lists_segment_group['list']->getSegmentSelectOptions(true)),
                    'multiple' => true,
