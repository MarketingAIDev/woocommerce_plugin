        ...
        @foreach ($servers as $key => $server)
            <tr>
                ...
                <td class="text-right text-nowrap">
                    ...
                    @endif
                    @if (request()->selected_customer->can('delete', $server) || request()->selected_customer->can('disable', $server) || request()->selected_customer->can('enable', $server))
                        <div class="btn-group">
                            <button type="button" class="btn dropdown-toggle" data-toggle="dropdown"><span class="caret ml-0"></span></button>
                            <ul class="dropdown-menu dropdown-menu-right">
                                @if (request()->selected_customer->can('enable', $server))
                                    <li>
                                ...
                                @endif
                                @if (request()->selected_customer->can('disable', $server))
                                    <li>
                                ...
                                @endif
                                @if (request()->selected_customer->can('delete', $server))
                                    <li>
