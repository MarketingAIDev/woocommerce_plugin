...
@section('page_header')
    ...
    <div class="page-title">
        ...
        <h1>
            <span class="text-semibold">{{ request()->selected_customer->displayName() }}</span>
        </h1>
    </div>
            ...
            <div class="sub-section">
                ...
                @if ($subscription->isActive())
                    ...
                    @else
                        ...
                        @if (request()->selected_customer->can('renew', $subscription) && !$hasPendingPaymentForFuture)
                        ...
                        @endif
                        @if (request()->selected_customer->can('changePlan', $subscription) && !$hasPendingPaymentForFuture)
                            <a
                                href="{{ action('AccountSubscriptionController@changePlan', ["id" => $subscription->uid]) }}"
                                class="btn bg-grey-600 mr-10 modal_link"
                                data-size="sm"
