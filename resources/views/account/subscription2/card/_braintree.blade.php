...
<div id="dropin-container"></div>
  <div class="payment-method-not-selected">
    <button class="btn btn-info bg-grey" id="submit-button">{{ trans('messages.payment.braintree.request_payment_method') }}</button>
  </div>
  <div class="payment-method-selected hide submit-button">
    <form action="{{ action('AccountSubscriptionController@subscribe', [
      ...
      method="POST">
        ...
        <button type="submit" class="btn btn-info bg-grey pay-button">{{ trans('messages.payment.braintree.pay') }}</a>
    </form>
...
<script>
  ...
  braintree.dropin.create({
    authorization: '{{ $gatewayService->getClientToken(request()->selected_customer->getRemoteOwnerId()) }}',
