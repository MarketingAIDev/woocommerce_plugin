...
@section('page_header')
    ...
    <div class="page-title">
        ...
        <h1>
            <span class="text-semibold"><i class="icon-quill4"></i> {{ request()->selected_customer->displayName() }}</span>
        </h1>
    </div>
    ...
    <div class="row">
        <div class="col-sm-12 col-md-8 col-lg-8">
            ...
            <div class="sub-section">
                ...
                @if (!$subscription->isActive())
                    ...
                    @elseif (!$subscription->isPaid())
                        ...
                        @if (!$subscription->isPaid() && !$subscription->isActive())
                            @if (request()->selected_customer->can('pay', $subscription))
                    ...
                    @if (\request()->selected_customer->can('delete', $subscription))
                ...
                @else
                    ...
                    <ul class="dotted-list topborder section">
                        ...
                        <li class="hide">
                            ...
                            <div class="lastUnit size1of2">
                                <mc:flag><span class="">{{ \Acelle\Library\Tool::format_number(request()->selected_customer->getSendingQuotaUsage()) }}/{{ (request()->selected_customer->getSendingQuota() == -1) ? '∞' : \Acelle\Library\Tool::format_number(request()->selected_customer->getSendingQuota()) }}</span>
                                &nbsp;&nbsp;&nbsp;{{ request()->selected_customer->displaySendingQuotaUsage() }}</mc:flag>
                            </div>
                        </li>
                        <li class="hide">
                            <div class="unit size1of2">
                        ...
                        <li class="hide">
                            ...
                            <div class="lastUnit size1of2">
                                <mc:flag><span class="">{{ \Acelle\Library\Tool::format_number(request()->selected_customer->listsCount()) }}/{{ \Acelle\Library\Tool::format_number(request()->selected_customer->maxLists()) }}</span>
                                &nbsp;&nbsp;&nbsp;{{ request()->selected_customer->displayListsUsage() }}</mc:flag>
                            </div>
                        </li>
                        <li class="hide">
                            <div class="unit size1of2">
                            ...
                            <div class="lastUnit size1of2">
                                <mc:flag><span class="">{{ \Acelle\Library\Tool::format_number(request()->selected_customer->readCache('SubscriberCount', 0)) }}/{{ \Acelle\Library\Tool::format_number(request()->selected_customer->maxSubscribers()) }}</span>
                                &nbsp;&nbsp;&nbsp;{{ request()->selected_customer->displaySubscribersUsage() }}</mc:flag>
                            </div>
                        </li>
                        <li class="hide">
                            <div class="unit size1of2">
                            ...
                            <div class="lastUnit size1of2">
                                <mc:flag><span class="">{{ \Acelle\Library\Tool::format_number(request()->selected_customer->campaignsCount()) }}/{{ \Acelle\Library\Tool::format_number(request()->selected_customer->maxCampaigns()) }}</span>
                                &nbsp;&nbsp;&nbsp;{{ request()->selected_customer->displayCampaignsUsage() }}</mc:flag>
                            </div>
                        </li>
                        <li class="hide">
                            <div class="unit size1of2">
                            ...
                            <div class="lastUnit size1of2">
                                <mc:flag><span class="">{{ \Acelle\Library\Tool::format_number(request()->selected_customer->automationsCount()) }}/{{ \Acelle\Library\Tool::format_number(request()->selected_customer->maxAutomations()) }}</span>
                                &nbsp;&nbsp;&nbsp;{{ request()->selected_customer->displayAutomationsUsage() }}</mc:flag>
                            </div>
                        </li>
                        <li class="hide">
                            <div class="unit size1of2">
                            ...
                            <div class="lastUnit size1of2">
                                <mc:flag><span class="text-muted progress-xxs">{{ \Acelle\Library\Tool::format_number(round(request()->selected_customer->totalUploadSize(),2)) }}/{{ \Acelle\Library\Tool::format_number(request()->selected_customer->maxTotalUploadSize()) }} (MB)</span>
                                &nbsp;&nbsp;&nbsp;{{ request()->selected_customer->totalUploadSizeUsage() }}%</mc:flag>
                            </div>
                        </li>
                        <li class="hide">
                            <div class="unit size1of2">
                            ...
                            <div class="lastUnit size1of2">
                                <mc:flag>
                                    @if (request()->selected_customer->can("create", new Acelle\Model\SendingServer()))
                                        <span class="">{{ \Acelle\Library\Tool::format_number(request()->selected_customer->sendingServersCount()) }}/{{ \Acelle\Library\Tool::format_number(request()->selected_customer->maxSendingServers()) }}</span>
                            ...
                            <div class="lastUnit size1of2">
                                <mc:flag>
                                    @if (request()->selected_customer->can("create", new Acelle\Model\EmailVerificationServer()))
                                        <span class="">{{ \Acelle\Library\Tool::format_number(request()->selected_customer->emailVerificationServersCount()) }}/{{ \Acelle\Library\Tool::format_number(request()->selected_customer->maxEmailVerificationServers()) }}</span>
            ...
            @if (!$subscription->isTimeUnlimited())
                    <div class="sub-section">
                    @if (!$nextSubscription)
                        @if (\request()->selected_customer->can('create', new Acelle\Model\Subscription()))
                    ...
                    @elseif (!$nextSubscription->isActive())
                        ...
                        @if (!$nextSubscription->isPaid() && !$nextSubscription->isActive())
                            @if (request()->selected_customer->can('pay', $nextSubscription))
                            ...
                            @endif
                        @endif
                        @if (\request()->selected_customer->can('delete', $nextSubscription))
