    ...
    @if (count($subscribers))
        ...
        >
            ...
            <div class="text-center">
                <button class="btn btn-info bg-grey mt-4">{{ trans('messages.bulk_delete.ok_delete') }}</button>
            </div>
        </form>
    @else
        ...
        <div class="text-center">
            <button onclick="bulkDeletePopup.back()" class="btn btn-info bg-grey mt-4">{{ trans('messages.return_back') }}</button>
        </div>
    @endif
