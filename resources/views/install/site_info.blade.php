...
<form action="{{ action('InstallController@siteInfo') }}" method="POST" class="form-validate-jqueryz">
	...
	<div class="text-right">                                    
		<button data-wait="{{ trans('messages.button_processing') }}" type="submit" class="btn btn-info bg-teal">{!! trans('messages.next') !!} <i class="icon-arrow-right14 position-right"></i></button>
	</div>
