...
var data_basic = {
	'snippets': [
		/* LOGO */
		{
			'thumbnail': 'preview/logo-1.png',
			'category': '1',
			'html': '<div style="width: 100%; max-width: 100%; text-align: left;"><img src="/cb/assets/minimalist-blocks/images/placeholder.png" style="max-width: 100%; width: 150px;" alt="Signature Image"></div>'
		},
		{
			'thumbnail': 'preview/logo-2.png',
			'category': '1',
			'html': '<div style="width: 100%; max-width: 100%; text-align: center;"><img src="/cb/assets/minimalist-blocks/images/placeholder.png" style="max-width: 100%; width: 150px;" alt="Signature Image"></div>'
		},
		{
			'thumbnail': 'preview/logo-3.png',
			'category': '1',
			'html': '<div style="width: 100%; max-width: 100%; text-align: right;"><img src="/cb/assets/minimalist-blocks/images/placeholder.png" style="max-width: 100%; width: 150px;" alt="Signature Image"></div>'
		},
		/* PRODUCTS */
		{
			...
			'html':
				`
				<table class="dynamic-products" data-count="1" product-source="1" product-id="1" style="background-color:#ffffff;color:#000000; width: 100%;">
					<tr style="padding: 0">
						<td style="padding: 0">
							<img class="dynamic-products-image-0 no-image-edit" contenteditable="false"
								src="/cb/assets/minimalist-blocks/images/photo-1459411552884-841db9b3cc2a-YO89Y1.jpg"
								alt="" style="width: 100%;">
						</td>
					</tr>
					<tr style="padding: 0">
						<td style="padding: 0">
							<h3 contenteditable="false"><span class="dynamic-products-title-0">sample product</span> <span  class="dynamic-products-price-0" contenteditable="false" style="font-weight: bold;">USD
									109.00</span></h3>
						</td>
					</tr>
					<tr style="padding: 0">
						<td style="padding: 0">
							<p class="dynamic-products-description-0" contenteditable="false">Desdsd</p>
						</td>
					</tr>
					<tr style="padding: 0">
						<td style="padding: 0">
							<a contenteditable="false"
								...
								href="#" style="color:#000000;background-color:#ffffff;border-color:#000000">Buy Now</a></span>
						</td>
					</tr>
				</table>
				`
		},
		{
			...
			'category': '1001',
			'html':
				`<table class="dynamic-products" data-count="3" product-source="1,1,1" product-id="1,1,1" style="table-layout: fixed;background-color:#ffffff;color:#000000; width: 100%;">
					<tr>
					...
					<tr style="padding: 0">
						<td style="padding: 0">
							<img class="dynamic-products-image-0 no-image-edit" contenteditable="false"
								src="/cb/assets/minimalist-blocks/images/h-e-n-g-s-t-r-e-a-m-573432-unsplash-xt89A1.jpg"
								alt="" style="width: 100%;">
						</td>
						<td style="padding: 0">
							<img class="dynamic-products-image-1 no-image-edit" contenteditable="false"
								src="/cb/assets/minimalist-blocks/images/sarah-dorweiler-357724-unsplash-4cfGV2.jpg"
								alt="" style="width: 100%;">
						</td>
						<td style="padding: 0">
							<img class="dynamic-products-image-2 no-image-edit" contenteditable="false"
								src="/cb/assets/minimalist-blocks/images/michael-frattaroli-234662-unsplash-QaduA1.jpg"
								alt="" style="width: 100%;">
						</td>
					</tr>
					<tr style="padding: 0">
						<td style="padding: 0">
							<h5 class="size-18" contenteditable="false"><span class="dynamic-products-title-0" style="font-weight: 400;">sample product</span> <span  class="dynamic-products-price-0" contenteditable="false" style="color: rgb(136, 136, 136);">USD 109.00</span></h5>
						</td
						<td style="padding: 0">
							<h5 class="size-18" contenteditable="false"><span class="dynamic-products-title-1" style="font-weight: 400;">sample product</span> <span  class="dynamic-products-price-1" contenteditable="false" style="color: rgb(136, 136, 136);">USD 109.00</span></h5>
						</td
						<td style="padding: 0">
							<h5 class="size-18" contenteditable="false"><span class="dynamic-products-title-2" style="font-weight: 400;">sample product</span> <span  class="dynamic-products-price-2" contenteditable="false" style="color: rgb(136, 136, 136); ">USD 109.00</span></h5>
						</td>
					</tr>
					<tr style="padding: 0">
						<td style="padding: 0">
						...
						<td style="padding: 0">
							<p class="dynamic-products-description-1" contenteditable="false">Desdsd</p>
						</td>
						<td style="padding: 0">
							<p class="dynamic-products-description-2" contenteditable="false">Desdsd</p>
						</td>
					</tr>
					<tr style="padding: 0">
						<td style="padding: 0">
							<a contenteditable="false"
								class="dynamic-products-button-0 is-btn is-btn-small is-btn-ghost1 is-upper edit readonly-link"
								href="#" style="color:#009e91;background-color:transparent;border-color:transparent;letter-spacing: 1px;
								padding: 0 5px;">Buy Now</a></span>
						</td>
						<td style="padding: 0">
							<a contenteditable="false"
								class="dynamic-products-button-1 is-btn is-btn-small is-btn-ghost1 is-upper edit readonly-link"
								href="#" style="color:#009e91;background-color:transparent;border-color:transparent;letter-spacing: 1px;
								padding: 0 5px;">Buy Now</a></span>
						</td>
						<td style="padding: 0">
							<a contenteditable="false"
								class="dynamic-products-button-2 is-btn is-btn-small is-btn-ghost1 is-upper edit readonly-link"
								href="#" style="color:#009e91;background-color:transparent;border-color:transparent;letter-spacing: 1px;
								padding: 0 5px;">Buy Now</a></span>
						</td>
					</tr>
		...
		},
		{
			...
			'html':
				`
				<table class="dynamic-products" data-count="2" product-source="1,1" product-id="1,1"
        style="background-color: rgb(255, 255, 255); color: rgb(0, 0, 0); width: 100%; max-width: 100%;">
        <tbody style="max-width: 100%;">
            <tr style="padding: 0px; max-width: 100%;">
                <td style="padding: 0px; max-width: 100%;vertical-align: baseline;">
					<h5 class="dynamic-products-title-0 size-28" style="max-width: 100%;">sample product</h5>
					<p class="dynamic-products-price-0" style="font-weight: bold; max-width: 100%;">USD 109.00</p>
                    <p class="dynamic-products-description-0" style="max-width: 100%;">Desdsd</p>
                    <span style="max-width: 100%;"><a
                            class="dynamic-products-button-0 is-btn is-btn-small is-btn-ghost1 is-upper edit readonly-link"
                            href="http://127.0.0.1:5501/index.html#"
                            style="color: rgb(0, 0, 0); background-color: rgb(255, 255, 255); border-color: rgb(0, 0, 0); max-width: 100%;">Buy
                            Now</a></span>
                </td>
                <td style="padding: 0px; max-width: 100%;padding-left: 20px;">
                    <img class="dynamic-products-image-0 no-image-edit"
                        src="/cb/assets/minimalist-blocks/images/-5v3uL1.jpg"
                        alt="" style="width: 100%; max-width: 100%;">
                </td>
            </tr>
            <tr style="padding: 0px; max-width: 100%;">
                <td style="padding: 0px; max-width: 100%;">
                    <img class="dynamic-products-image-1 no-image-edit"
                        src="/cb/assets/minimalist-blocks/images/-C3XHH1.jpg"
                        alt="" style="width: 100%; max-width: 100%;">
                </td>
                <td style="padding: 0px; max-width: 100%;vertical-align: baseline;padding-left: 20px;">
					...
					<p class="dynamic-products-price-1" style="font-weight: bold; max-width: 100%;">USD 109.00</p>
                    <p class="dynamic-products-description-1" style="max-width: 100%;">Desdsd</p>
                    <span style="max-width: 100%;"><a
                            class="dynamic-products-button-1 is-btn is-btn-small is-btn-ghost1 is-upper edit readonly-link"
                            href="http://127.0.0.1:5501/index.html#"
                            style="color: rgb(0, 0, 0); background-color: rgb(255, 255, 255); border-color: rgb(0, 0, 0); max-width: 100%;">Buy
		...
		},
		{
			...
			'category': '1001',
			'html':
				`<table class="dynamic-products" data-count="2" product-source="1,1" product-id="1,1" style="background-color:#ffffff;color:#000000; width: 100%;">
				<tr>
					<td colspan="2"><h1 class="size-38" style="font-weight: 400;">OUR PRODUCTS</h1></td>
				</tr>
				<tr style="padding: 0">
					...
					<td style="padding: 0">
						<img class="dynamic-products-image-1 no-image-edit" contenteditable="false"
							src="/cb/assets/minimalist-blocks/images/photo-1471256737566-c7ddd846bee0-small-NBNfZ2.jpg"
							alt="" style="width: 100%;">
					</td>
				</tr>
				<tr style="padding: 0">
					<td style="padding: 0">
						<h5  class="size-18" contenteditable="false"><span class="dynamic-products-title-0">sample product</span> <span  class="dynamic-products-price-0" contenteditable="false" style="font-weight: bold;">USD
								109.00</span></h5>
					</td>
					<td style="padding: 0">
						<h5  class="size-18" contenteditable="false"><span class="dynamic-products-title-1">sample product</span> <span  class="dynamic-products-price-1" contenteditable="false" style="font-weight: bold;">USD
								109.00</span></h5>
					</td>
				</tr>
				<tr style="padding: 0">
		...
		{
			'thumbnail': 'preview/ew_dynamic_cart.png',
			'category': '1002',
			'html': `
					...
					<tbody class="abandoned-body-starts" data-isdescription="1" abandoned-body-starts-r1="" abandoned-body-starts-r1-c1="" abandoned-body-starts-r1-c1-item="" abandoned-body-starts-r1-c1-item-table="" abandoned-body-starts-r1-c1-item-r1="" abandoned-body-starts-r1-c1-item-r1-c1="" abandoned-body-starts-r1-c1-item-r1-c1-img="" abandoned-body-starts-r1-c1-item-r1-c2="" abandoned-body-starts-r1-c1-item-r1-c2-title="" abandoned-body-starts-r1-c1-item-r1-c2-info="" abandoned-body-starts-r1-c1-item-r1-c2-price="" abandoned-body-starts-r1-c2="" abandoned-body-starts-r1-c2-qty="" abandoned-body-starts-r1-c3="" abandoned-body-starts-r1-c3-price="">
						<tr class="abandoned-body-starts-r1">
								...
								<div class="item abandoned-body-starts-r1-c1-item">
									<table class="abandoned-body-starts-r1-c1-item-table">
										<tr class="abandoned-body-starts-r1-c1-item-r1">
											<td class="abandoned-body-starts-r1-c1-item-r1-c1"><img class="abandoned-body-starts-r1-c1-item-r1-c1-img" src="/cb/assets/minimalist-blocks/images/placeholder.png" width="100px">
											</td>
											<td class="mobile-info abandoned-body-starts-r1-c1-item-r1-c2">
												<div contenteditable="false" class="item-title abandoned-body-starts-r1-c1-item-r1-c2-title">Title</div>
												<div contenteditable="false" class="item-info abandoned-body-starts-r1-c1-item-r1-c2-info">Info</div>
												<div contenteditable="false" class="mobile-qty-price abandoned-body-starts-r1-c1-item-r1-c2-price">1 x $1.00</div>
											</td>
										</tr>
									</table>
								</div>
							...
							<td class="abandoned-body-starts-r1-c2">
								<div contenteditable="false" class="qty abandoned-body-starts-r1-c2-qty">1</div>
							</td>
							<td class="abandoned-body-starts-r1-c3">
								<div contenteditable="false" class="price abandoned-body-starts-r1-c3-price">$1.00</div>
							</td>
						</tr>
					</tbody>
				</table>
		...
		},
		{
			...
			<div class="submit-review-product row clearfix" product-source="0" style="text-align: center;">
				<div class="column full">
					...
					<h2 style="font-size: 22px; color: rgb(102, 102, 102); font-weight: 500;">Product Title</h2>
					<a href="#" title="">
						<img class="no-image-edit" src="/cb/assets/minimalist-blocks/images/0_stars.png" alt="" loading="lazy" style="width: 60%; height: 10%;">
					</a>
				</div>
		...
		{
			'thumbnail': 'preview/ew_dynamic_chat.png',
			'category': '1003',
			'html':
				'<div class="ew_dynamic_chat">' +
				'<iframe style="pointer-events:none;width:100%" src="/ew_dynamic/iframe?type=chat" frameborder="0" allowfullscreen="" ' +
		...
		},
		{
			...
			'html':
			`
		<div class="chat-top-bar" style="width: 100vw; height: 5px; background: #50416C;"></div>
        <div class="row clearfix">
		...
		<div class="chat-main-container row clearfix" style="margin-left: 0 !important;">
			<div class="column full chat-dynamic-content-container" data-noedit="">
				<div class="row clearfix" style="margin-left: 0 !important;">
					<div class="column full" data-noedit="">
						<div class="left-chat-bubble">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam sapiente fugiat suscipit dolore molestiae eos facilis sequi magni quidem voluptas eum ratione quaerat eligendi, consequatur itaque fuga cum inventore tempora?</div>
						<div class="chat-bubble-time"><span class="chat-bubble-time-title">{In_Firstname}</span> 1:22pm</div>
					</div>
				</div>
				<div class="row clearfix" style="margin-left: 0 !important;">
					<div class="column full" data-noedit="">
				...
				<div class="row clearfix" style="margin-left: 0 !important;">
					<div class="column full" data-noedit="">
						<div class="right-chat-bubble">Lorem ipsum dolor sit amet consectetur adipisicing elit. Nam sapiente fugiat suscipit dolore molestiae eos facilis sequi magni quidem voluptas eum ratione quaerat eligendi, consequatur itaque fuga cum inventore tempora?</div>
						<div class="chat-bubble-time right"><span class="chat-bubble-time-title">You</span> 1:22pm</div>
					</div>
				</div>
			</div>
        </div>`
	...
	<div style="text-align:center" class="social-buttons-container">
		<a class="social-button-link" data-title="Twitter"  href=" $sig_twitter " style="background-color: #00bfff;" style="padding: 5px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-social-twitter-white.png" style="width: 24px; height: 24px;display: inline-block; vertical-align: middle;  margin: 10px;">
		</a>
		<a class="social-button-link" data-title="Facebook" href=" $sig_facebook " style="background-color: #128BDB" style="padding: 5px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-social-facebook-white.png" style="width: 24px; height: 24px;display: inline-block; vertical-align: middle;  margin: 10px;">
		</a>
		<a class="social-button-link" data-title="Instagram" href=" $sig_instagram " style="background-color: #00bfff" style="padding: 5px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-social-instagram-white.png" style="width: 24px; height: 24px;display: inline-block; vertical-align: middle;  margin: 10px;">
		</a>
		<a class="social-button-link" data-title="LinkedIn" href=" $sig_linkedin " style="background-color: #128BDB" style="padding: 5px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-social-linkedin-white.png" style="width: 24px; height: 24px;display: inline-block; vertical-align: middle;  margin: 10px;">
		</a>
		<a class="social-button-link" data-title="Skype" href=" $sig_skype " style="background-color: #00bfff" style="padding: 5px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-social-skype-white.png" style="width: 24px; height: 24px;display: inline-block; vertical-align: middle;  margin: 10px;">
		</a>
		<a class="social-button-link" data-title="Mail" href=" $sig_email " style="background-color: #DF311F" style="padding: 5px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-android-drafts-white.png" style="width: 24px; height: 24px;display: inline-block; vertical-align: middle;  margin: 10px;">
		</a>
	</div>
	<p></p>
</div>
`
...

		{
			...
			'category': '120',
			'html':
				`<div style="margin: 1em 0px; text-align: center; max-width: 100%;" class="is-rounded-button-medium social-media-buttons-holder social-buttons-container">
				<a class="social-button-link" data-title="Twitter" href="" style="background-color: rgb(0, 191, 255); max-width: 100%;" contenteditable="true" id="zRwOIWa">
					<img class="social-button-icon no-image-edit" src="/cb/assets/icons/ion-social-twitter-white.png" style="width: 24px; height: 24px; display: inline-block; vertical-align: middle; margin: 10px; max-width: 100%;" />
				</a>
				<a class="social-button-link" data-title="Facebook" href="" style="background-color: rgb(18, 139, 219); max-width: 100%;" contenteditable="true" id="UxeW6hK">
					<img class="social-button-icon no-image-edit" src="/cb/assets/icons/ion-social-facebook-white.png" style="width: 24px; height: 24px; display: inline-block; vertical-align: middle; margin: 10px; max-width: 100%;" />
				</a>
				<a class="social-button-link" data-title="Instagram" href="" style="background-color: rgb(0, 191, 255); max-width: 100%;" contenteditable="true" id="IIVTGM0">
					<img class="social-button-icon no-image-edit" src="/cb/assets/icons/ion-social-instagram-white.png" style="width: 24px; height: 24px; display: inline-block; vertical-align: middle; margin: 10px; max-width: 100%;" />
				</a>
				<a class="social-button-link" data-title="LinkedIn" href="" style="background-color: rgb(18, 139, 219); max-width: 100%;" contenteditable="true" id="JDCBoAY">
					<img class="social-button-icon no-image-edit" src="/cb/assets/icons/ion-social-linkedin-white.png" style="width: 24px; height: 24px; display: inline-block; vertical-align: middle; margin: 10px; max-width: 100%;" />
				</a>
				<a class="social-button-link" data-title="Skype" href="" style="background-color: rgb(0, 191, 255); max-width: 100%;" contenteditable="true" id="Qa17pcn">
					<img class="social-button-icon no-image-edit" src="/cb/assets/icons/ion-social-skype-white.png" style="width: 24px; height: 24px; display: inline-block; vertical-align: middle; margin: 10px; max-width: 100%;" />
				</a>
				<a class="social-button-link" data-title="Mail" href="mailto:emailwish.tester.1@gmail.com" style="background-color: rgb(223, 49, 31); max-width: 100%;" contenteditable="true" id="XCmoHli">
					<img class="social-button-icon no-image-edit" src="/cb/assets/icons/ion-android-drafts-white.png" style="width: 24px; height: 24px; display: inline-block; vertical-align: middle; margin: 10px; max-width: 100%;" />
				</a>
			</div>`
		},
	...
	<p></p>
	<div style="text-align:center" class="social-buttons-container">
		<a class="social-button-link" data-title="Twitter"  href=" $sig_twitter " style="background-color: #00bfff; text-align: center; width: 45px; height: 45px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-social-twitter-white.png" style="height: 60%;display: inline-block; margin-top: 9px;">
		</a>
		<a class="social-button-link" data-title="Facebook" href=" $sig_facebook " style="background-color: #128BDB; text-align: center; width: 45px; height: 45px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-social-facebook-white.png" style="height: 60%;display: inline-block; margin-top: 9px;">
		</a>
		<a class="social-button-link" data-title="Instagram" href=" $sig_instagram " style="background-color: #00bfff; text-align: center; width: 45px; height: 45px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-social-instagram-white.png" style="height: 60%;display: inline-block; margin-top: 9px;">
		</a>
		<a class="social-button-link" data-title="LinkedIn" href=" $sig_linkedin " style="background-color: #128BDB; text-align: center; width: 45px; height: 45px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-social-linkedin-white.png" style="height: 60%;display: inline-block; margin-top: 9px;">
		</a>
		<a class="social-button-link" data-title="Skype" href=" $sig_skype " style="background-color: #00bfff; text-align: center; width: 45px; height: 45px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-social-skype-white.png" style="height: 60%;display: inline-block; margin-top: 9px;">
		</a>
		<a class="social-button-link" data-title="Mail" href=" $sig_email " style="background-color: #DF311F; text-align: center; width: 45px; height: 45px;">
			<img class="social-button-icon no-image-edit"  src="/cb/assets/icons/ion-android-drafts-white.png" style="height: 60%;display: inline-block; margin-top: 9px;">
		</a>
	</div>
	<p></p>
</div>`
...

		{
			...
			'category': '1101',
			'html':
				'<div class="is-rounded-button-medium social-buttons-container social-media-buttons-holder" style="margin:1em 0">' +
				'<a href="https://twitter.com/" style="background-color: #00bfff;" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon" ></i></a>' +
				'<a href="https://www.facebook.com/" style="background-color: #128BDB" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon"></i></a>' +
				'<a href="mailto:you@example.com" style="background-color: #DF311F" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon"></i></a>' +
				'</div>&nbsp;'
		},
		...
		// Slider Module (Slick)
		{
			...
			'html':
				...
				encodeURIComponent('<div id="{id}" class="slider-on-content" style="width:100%;height:500px;display:none">' +
					'<div class="is-boxes slider-image" style="background-image: url(\'/cb/assets/minimalist-blocks/images/slide1.jpg\');">' +
					'</div>' +
					'<div class="is-boxes slider-image" style="background-image: url(\'/cb/assets/minimalist-blocks/images/slide2.jpg\');">' +
					'</div>' +
					'<div class="is-boxes slider-image" style="background-image: url(\'/cb/assets/minimalist-blocks/images/slide3.jpg\');">' +
					'</div>' +
					'</div>' +
					'' +
					'<scr' + 'ipt>' +
		...
		// Slider Module (Glide) => Experimental
		{
			...
			'html':
				...
				encodeURIComponent('' +
					...
					'<div data-subblock><img data-image-embed data-noresize data-sync src="/cb/assets/minimalist-blocks/images/slide2.jpg" alt="" /></div>' +
					'<div class="is-slider-caption" style="left:4vw;bottom:4vw">Lorem Ipsum</div>' +
					'</li>' +
					'<li class="glide__slide">' +
					'<div data-subblock><img data-image-embed data-noresize data-sync src="/cb/assets/minimalist-blocks/images/slide3.jpg" alt="" /></div>' +
					'</li>' +
					'</ul>' +
					'</div>' +
					'' +
...

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column full center">' +
				'<h1 class="size-48 is-title4-48" style="letter-spacing:5px;overflow-wrap: anywhere;">STUNNING</h1>' +
				'</div>' +
				'</div>'
		},

		{
			...
			'html':
				...
				'<div class="column full center">' +
				'<div class="display">' +
				_tabs(1) + '<h1 class="size-92" style="margin-bottom:0;overflow-wrap: anywhere;">Outstanding</h1>' +
...

		{
			...
			'html':
				...
				'\n<div class="display">' +
				_tabs(1) + '<h1 class="size-80" style="overflow-wrap: anywhere;">Café & Bistro</h1>' +
				'\n</div>' +
				'\n<p style="overflow-wrap: anywhere;"><i>Lorem Ipsum is simply dummy text</i></p>' +
				'</div>' +
				'</div>'
		},

		{
			...
			'html':
				...
				'<div class="column full center">' +
				'<div class="display">' +
				_tabs(1) + '<h1 style="overflow-wrap: anywhere;">Calm, Pure, and lovely</h1>' +
...

		{
			...
			'html':
				...
				'<div class="column full center">' +
				'<div class="display">' +
				_tabs(1) + '<h1 class="size-80 is-title1-80 is-title-lite" style="overflow-wrap: anywhere;">Pure & Healthy</h1>' +
				'\n</div>' +
				'\n<p style="overflow-wrap: anywhere;" class="size-21">Lorem Ipsum has been the industry\'s standard text ever since the 1500s, when an unknown printer took a galley of type</p>' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
				'<div class="column full center">' +
...

		{
			...
			'html':
				...
				'<div class="column full right">' +
				'<div class="display">' +
				_tabs(1) + '<p class="size-21 is-info2" style="overflow-wrap: anywhere;">Welcome to our coffee shop</p>' +
				_tabs(1) + '<h1 class="size-100" style="text-transform: none;overflow-wrap: anywhere;">Smell it, taste it.</h1>' +
				'\n</div>' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
...

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column full center">' +
				'<h1 class="size-60" style="overflow-wrap: anywhere;">Planning a memorable trip? You came to the right place.</h1>' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
				'<div class="column full center">' +
...

		{
			...
			'html':
				...
				'<div class="column full center">' +
				'<div class="display">' +
				_tabs(1) + '<p class="size-21" style="overflow-wrap: anywhere;">We are Creative Agency in New York</p>' +
				_tabs(1) + '<h1 class="size-112" style="overflow-wrap: anywhere;"><b>CLEAN. SIMPLE.</b></h1>' +
				'\n</div>' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
...

		{
			...
			'html':
				...
				'<div class="column full center">' +
				'<div class="display">' +
				_tabs(1) + '<h1 class="size-64" style="overflow-wrap: anywhere;">Good for Health, Good for You</h1>' +
				'\n</div>' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
...

		{
			...
			'html':
				...
				'<div class="column full center">' +
				'<div class="display">' +
				_tabs(1) + '<h1 class="size-108" style="overflow-wrap: anywhere;">Stitch Studio</h1>' +
...

		{
			...
			'html':
				...
				'<div class="column full center">' +
				'<div class="display">' +
				_tabs(1) + '<h1 class="size-120" style="letter-spacing: 10px;overflow-wrap: anywhere;">Unique.</h1>' +
				_tabs(1) + '<p style="overflow-wrap: anywhere;">PLAN YOUR SPECIAL DAY</p>' +
				'\n</div>' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
...

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column full center">' +
				'<h1 class="size-104 is-title-lite" style="overflow-wrap: anywhere;">DREAM HOME</h1>' +
				'\n<p class="size-24" style="overflow-wrap: anywhere;">BEAUTIFY YOUR HOME WITH MODERN FURNITURE SET.</p>' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
				'<div class="column full center">' +
...

		{
			...
			'html':
				...
				'<div class="column full right">' +
				'<div class="display">' +
				_tabs(1) + '<h1 class="size-48" style="overflow-wrap: anywhere;">We Create and Design Beautiful Websites</h1>' +
				'\n</div>' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
...

		{
			...
			'html':
				...
				'<div class="column full right">' +
				'<div class="display">' +
				_tabs(1) + '<h1 class="size-132" style="letter-spacing: 8px;overflow-wrap: anywhere;">Tasty</h1>' +
...

		{
			...
			'html':
				...
				'<div class="column full">' +
				'<div class="display">' +
				_tabs(1) + '<h1 class="size-100" style="letter-spacing: 7px;overflow-wrap: anywhere;">Mike Watson</h1>' +
				_tabs(1) + '<p class="size-21" style="overflow-wrap: anywhere;">Expert in Public Interior Design</p>' +
				'\n</div>' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
...

		{
			...
			'html':
				...
				'<div class="column full">' +
				'<div class="display">' +
				_tabs(1) + '<h1 class="size-80" style="text-transform: none;overflow-wrap: anywhere;">Monday to Friday</h1>' +
				_tabs(1) + '<p style="overflow-wrap: anywhere;">We make shopping way easier and convenient for you</p>' +
				'\n</div>' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
...

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column full">' +
				'<h1 class="size-42" style="letter-spacing: 3px;overflow-wrap: anywhere;">Struggling to find the perfect event organizer? No worries. We\'re here to help you creating the event like no other.</h1>' +
				'</div>' +
				'</div>'
		},

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column full">' +
				'<h1 class="size-48 is-title1-48 is-title-bold" style="line-height:1.7;overflow-wrap: anywhere;">Design<br>in<br>Silence</h1>' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
				'<div class="column full">' +
				...
				'<div class="row clearfix">' +
				'<div class="column full">' +
				'<p style="text-align: right; font-style: italic;overflow-wrap: anywhere;">Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s, when an<br>unknown printer took a galley of type and scrambled it to make a type specimen book.</p>' +
				'</div>' +
				'</div>'
		},
...

		{
			...
			'html':
				...
				_tabs(1) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon" ></i></a>' +
				_tabs(1) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon"></i></a>' +
				_tabs(1) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon"></i></a>' +
				'\n</div>' +
				'</div>' +
				'<div class="column third center">' +
...

		{
			...
			'html':
				...
				_tabs(3) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon"  style="margin-right: 1em; color: #fff"></i></a>' +
				_tabs(3) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon" style="margin-right: 1em; color: #fff"></i></a>' +
				_tabs(3) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon" style="color: #fff"></i></a>' +
				_tabs(2) + '</div>' +
				_tabs(1) + '</div>' +
				'\n</div>' +
				'</div>' +
...

		{
			...
			'html':
				...
				'\n<div class="size-12 is-social edit social-buttons-container">' +
				_tabs(1) + '<a href="https://twitter.com/ social-buttons-container" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon" ></i></a>' +
				_tabs(1) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon"></i></a>' +
				_tabs(1) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon"></i></a>' +
				'\n</div>' +
				'</div>' +
...

		{
			...
			'html':
				...
				'</div>' +
				'<div class="column half center">' +
				'<img src="/cb/assets/minimalist-blocks/images/simon-migaj-775713-unsplash-l8oSx1.jpg" alt="" style="border-radius: 500px;">' +
				'</div>' +
				'</div>'
		},

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-6Q6W91.jpg" alt="">' +
				'</div>' +
				'<div class="column half">' +
				'<div class="spacer height-80"></div>' +
				'\n<h1 style="text-transform: uppercase; letter-spacing: 6px; text-align: right;">Irene Waller</h1>' +
				'\n<br>' +
				'\n<div class="is-social right social-buttons-container">' +
				_tabs(1) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon"  style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon" style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-android-drafts social-button-icon"></i></a>' +
				'\n</div>' +
				'\n<div class="spacer height-80"></div>' +
...

		{
			...
			'html':
				...
				'\n<br>' +
				'\n<div class="is-social social-buttons-container">' +
				_tabs(1) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon"  style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon" style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-android-drafts social-button-icon"></i></a>' +
				'\n</div>' +
				...
				'</div>' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-ayzzH2.jpg" alt="">' +
				'</div>' +
				'</div>'
		},

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-fxBmr1.jpg" alt="">' +
				'</div>' +
				'<div class="column half">' +
...

		{
			...
			'html':
				...
				'</div>' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-6SDpQ1.jpg" alt="">' +
				'</div>' +
				'</div>'
		},

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column half center">' +
				'<img src="/cb/assets/minimalist-blocks/images/-z01lr1.jpg" alt="">' +
				'</div>' +
				'<div class="column half">' +
				...
				'\n<div class="spacer height-20"></div>' +
				'\n<div class="is-social center social-buttons-container">' +
				_tabs(1) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon"  style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon" style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-android-drafts social-button-icon"></i></a>' +
				'\n</div>' +
...

		{
			...
			'html':
				...
				'</div>' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-SRJrq2.jpg" alt="">' +
				'</div>' +
				'</div>'
		},

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-otLsK1.jpg" alt="">' +
				'</div>' +
				'<div class="column half">' +
				...
				_tabs(1) + '<div class="spacer height-20"></div>' +
				_tabs(1) + '<div class="size-14 is-social edit social-buttons-container">' +
				_tabs(2) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon" ></i></a>' +
				_tabs(2) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon"></i></a>' +
				_tabs(2) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon"></i></a>' +
				_tabs(1) + '</div>' +
				'\n</div>' +
				'</div>' +
				'</div>'
...

		{
			...
			'html':
				...
				'</div>' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-TUrpQ1.jpg" alt="">' +
				'</div>' +
				'</div>'
		},

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column third center">' +
				'<img src="/cb/assets/minimalist-blocks/images/-DbQGW1.jpg" alt="" style="border-radius: 500px">' +
				'</div>' +
				'<div class="column two-third">' +
...

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column third center">' +
				'<img src="/cb/assets/minimalist-blocks/images/-gs7XT1.jpg" alt="">' +
				'</div>' +
				'<div class="column two-third">' +
...

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-DjWQ71.jpg" alt="" style="border-radius: 500px;">' +
				'</div>' +
				'<div class="column half">' +
				'<div style="padding-left:40px">' +
				...
				_tabs(1) + '<p style="text-align: justify;">Lorem Ipsum has been the industry\'s standard dummy text ever since the 1500s. Lorem Ipsum dolor sit amet.</p>' +
				_tabs(1) + '<div class="spacer height-20"></div>' +
				_tabs(1) + '<div class="size-14 is-social edit center social-buttons-container">' +
				_tabs(2) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon" ></i></a>' +
				_tabs(2) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon"></i></a>' +
				_tabs(2) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon"></i></a>' +
				_tabs(1) + '</div>' +
...

		{
			...
			'html':
				...
				'</div>' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-c2y4f1.jpg" alt="" style="border-radius: 500px;">' +
				'</div>' +
				'</div>'
		},
...

		{
			...
			'html':
				...
				'</div>' +
				'<div class="column third">' +
				'<img src="/cb/assets/minimalist-blocks/images/kara-michelle-544960-zjkQn1.jpg" alt="">' +
				'</div>' +
				'<div class="column third">' +
...

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column third">' +
				'<img src="/cb/assets/minimalist-blocks/images/aidan-hancock-440776-unsplash-8u7fo1.jpg" alt="">' +
				'</div>' +
				'<div class="column third">' +
...

		{
			...
			'html':
				...
				'<div class="row clearfix">' +
				'<div class="column half center">' +
				'<img src="/cb/assets/minimalist-blocks/images/-F0dm51.jpg" alt="">' +
				...
				'</div>' +
				'<div class="column half center">' +
				'<img src="/cb/assets/minimalist-blocks/images/-x5GRp1.jpg" alt="">' +
...

		{
			...
			'html':
				...
				'<div class="row clearfix">' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-S0R1k1.jpg" alt="">' +
				'\n<p>Lorem Ipsum is simply dummy text of the printing industry. — Nelson Sand</p>' +
				'</div>' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-QqxYJ2.jpg" alt="">' +
...

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column third center">' +
				'<img src="/cb/assets/minimalist-blocks/images/-F6TCZ1.jpg" alt="">' +
				'</div>' +
				'<div class="column two-third">' +
...

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column third center">' +
				'<img src="/cb/assets/minimalist-blocks/images/-Q1XSO1.jpg" alt="" style="border-radius: 500px">' +
				'</div>' +
				'<div class="column two-third">' +
				'<div style="margin-top:10px"><i class="icon ion-quote size-24" style="color: #888888"></i></div>' +
				'\n<p>Lorem Ipsum is simply dummy text of the printing and typesetting industry.</p>' +
...

		{
			...
			'html':
				...
				'<div class="row clearfix">' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-akB4h1.jpg" alt="">' +
				'</div>' +
				'<div class="column half">' +
				'<div class="quote">' +
				_tabs(1) + '<i class="icon ion-quote"></i>' +
				...
				'</div>' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-R79NY2.jpg" alt="">' +
				'</div>' +
				'</div>'
		},

		{
			...
			'html':
				...
				'<div class="row clearfix">' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-ybeSl1.jpg" alt="" style="border-radius: 500px;">' +
				'</div>' +
				'<div class="column half">' +
				'<div class="quote">' +
				_tabs(1) + '<i class="icon ion-quote"></i>' +
				...
				'</div>' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-KUCDN4.jpg" alt="" style="border-radius: 500px;">' +
				'</div>' +
				'</div>'
		},
...

		{
			...
			'html':
				...
				'<div class="row clearfix">' +
				'<div class="column third center">' +
				'<img src="/cb/assets/minimalist-blocks/images/watch-1663246_1920-8wuCM1.jpg" alt="">' +
				'\n<div class="spacer height-20"></div>' +
				...
				'</div>' +
				'<div class="column third center">' +
				'<img src="/cb/assets/minimalist-blocks/images/-frUlS1.jpg" alt="">' +
				'\n<div class="spacer height-20"></div>' +
				'\n<i class="icon ion-quote size-24"></i>' +
				'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
				'\n<p class="size-14">by Your Name</p>' +
				'</div>' +
				'<div class="column third center">' +
				'<img src="/cb/assets/minimalist-blocks/images/-RXypm2.jpg" alt="">' +
				'\n<div class="spacer height-20"></div>' +
				'\n<i class="icon ion-quote size-24"></i>' +
				'\n<p>Lorem Ipsum is simply dummy text of the printing industry.</p>' +
				'\n<p class="size-14">by Your Name</p>' +
...

		{
			...
			'html':
				...
				'<div class="row clearfix">' +
				'<div class="column third center">' +
				'<img src="/cb/assets/minimalist-blocks/images/noah-buscher-548633-ExLNF1.jpg" alt="" style="border-radius: 500px;">' +
				...
				'</div>' +
				'<div class="column third center">' +
				'<img src="/cb/assets/minimalist-blocks/images/icons8-team-355990-Voloz1.jpg" alt="" style="border-radius: 500px;">' +
				'\n<p style="color: #bdc3c7"><i class="icon ion-android-hangout size-32"></i></p>' +
				'\n<p class="size-16">Lorem Ipsum is simply dummy text of the printing industry. — Clara Wang</p>' +
				'</div>' +
				'<div class="column third center">' +
				'<img src="/cb/assets/minimalist-blocks/images/pexels-photo-girl-zZWwv1.jpg" alt="" style="border-radius: 500px;">' +
				'\n<p style="color: #bdc3c7"><i class="icon ion-android-hangout size-32"></i></p>' +
...

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-6PDKL1.jpg" alt="">' +
				'</div>' +
				'<div class="column half">' +
...

		{
			...
			'html':
				...
				'</div>' +
				'<div class="column half">' +
				'<img src="/cb/assets/minimalist-blocks/images/-OWu2H1.jpg" alt="">' +
				'</div>' +
				'</div>'
		},

		{
			...
			'html':
				...
				'<img src="/cb/assets/minimalist-blocks/images/-TK4An1.jpg" alt="" style="border-radius: 500px">' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
				'<div class="column center full">' +
...

		{
			...
			'html':
				...
				_tabs(2) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon"  style="margin-right: 1em"></i></a>' +
				_tabs(2) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon" style="margin-right: 1em"></i></a>' +
				_tabs(2) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon"></i></a>' +
				_tabs(1) + '</div>' +
				'\n</div>' +
				'</div>' +
...

		{
			...
			'html':
				...
				'\n<div class="spacer height-40"></div>' +
				'\n<div class="is-social edit size-18 social-buttons-container">' +
				_tabs(1) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon"  style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon" style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon"></i></a>' +
				'\n</div>' +
...

		{
			...
			'html':
				...
				'\n<div class="is-social edit size-18 social-buttons-container" style="margin: 30px 0">' +
				_tabs(1) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon"  style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon" style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon"></i></a>' +
				'\n</div>' +
...

		{
			...
			'html':
				...
				'\n<div class="spacer height-40"></div>' +
				'\n<div class="is-social edit">' +
				_tabs(1) + '<div class="size-18 social-buttons-container">' +
				_tabs(2) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon"  style="margin-right: 1em"></i></a>' +
				_tabs(2) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon" style="margin-right: 1em"></i></a>' +
				_tabs(2) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon"></i></a>' +
				_tabs(1) + '</div>' +
...

		{
			...
			'html':
				...
				'\n</p>' +
				'\n<div class="is-social edit size-16 social-buttons-container">' +
				_tabs(1) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon"  style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon" style="margin-right: 1em"></i></a>' +
				_tabs(1) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon"></i></a>' +
				'\n</div>' +
...

		{
			...
			'html':
				'<div class="row clearfix">' +
				'<div class="column full center">' +
				'<img src="/cb/assets/minimalist-blocks/images/-5TpV91.jpg" alt="">' +
				'</div>' +
				'</div>' +
				'<div class="row clearfix">' +
				'<div class="column full center">' +
			...
			'html':
				'<div class="row clearfix">' +
					'<div class="column half">' +
						...
						'\n<div class="spacer height-40"></div>' +
						'\n<div class="size-18 social-buttons-container">' +
							_tabs(1) + '<a href="https://twitter.com/" data-title="Twitter" class="social-button-link"><i class="icon ion-social-twitter social-button-icon"  style="margin-right: 1em"></i></a>' +
							_tabs(1) + '<a href="https://www.facebook.com/" data-title="Facebook" class="social-button-link"><i class="icon ion-social-facebook social-button-icon" style="margin-right: 1em"></i></a>' +
							_tabs(1) + '<a href="mailto:you@example.com" data-title="EMail" class="social-button-link"><i class="icon ion-ios-email-outline social-button-icon"></i></a>' +
						'\n</div>' +
